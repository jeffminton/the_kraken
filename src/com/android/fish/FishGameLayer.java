...
public class FishGameLayer extends CCColorLayer {
	...
	protected void addTarget() {
		...
		enemy.sprite.setPosition(winSize.width + (enemy.sprite.getContentSize().width/2.0f), actualY);
	...
	public boolean ccTouchesEnded(MotionEvent event)
	{
	    ...
	    friendly.sprite.setPosition(realX, realY);
